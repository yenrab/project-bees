...
- **Multi-core** — **balancing and affinitizing actors** to cores, and policies for fairness, preemption, and locality, appropriate to a Silica-backed runtime. On OS-hosted apps BEES balances BEAM-style between its carrier threads, and a pin is at most a preference. Running raw on a chip, it balances BEAM-style-ish directly onto the cores, and a pin is exclusive.
